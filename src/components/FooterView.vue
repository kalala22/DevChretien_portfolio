<template>
  <footer class="text-lg py-10 mt-10">
    ...
    >
      <!-- Logo -->
      <aside>
        <a href="#" class="font-bold text-2xl"> <span class="text-red-600">Dev</span>Chretien </a>
      </aside>

      <!-- Réseaux sociaux -->
      <nav class="flex flex-col items-center gap-3">
        <h6 class="font-montserrat text-xl">Suivez-moi sur</h6>
        <div class="flex gap-4">
          <!-- GitHub -->
          <a href="https://github.com/kalala22" target="_blank" rel="noopener noreferrer">
            <svg
            ...
            >
              <path
                d="M10.9,2.1c-4.6,0.5-8.3,4.2-8.8,8.7c-0.6,5,2.5,9.3,6.9,10.7v-2.3c0,0-0.4,0.1-0.9,0.1c-1.4,0-2-1.2-2.1-1.9
          ...
          <!-- LinkedIn -->
          <a
            href="https://www.linkedin.com/in/chretien-kalala-734260268/"
            target="_blank"
          ...
          >
            ...
            >
              <path
                ...
                M17,20v19h-6V20H17z M11,14.47c0-1.4,1.2-2.47,3-2.47s2.93,1.07,3,2.47c0,1.4-1.12,2.53-3,2.53C12.2,17,11,15.87,11,14.47z
