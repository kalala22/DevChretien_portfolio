...
<template>
  <main id="home" class="min-h-screen flex items-center justify-center p-4">
    <transition name="fade-in">
      <div
        v-if="isLoaded"
        class="flex flex-col md:flex-row items-center justify-center gap-16 max-w-7xl"
      >
        <div class="text-center md:text-left space-y-4 text-primary order-2 md:order-1">
          <h1 class="font-semibold text-4xl md:text-5xl">
            Salut Je suis<br />
            <span class="font-extrabold text-6xl md:text-7xl">Chretien Kalala,</span>
          </h1>
          <p class="text-2xl md:text-4xl font-extrabold">Full-Stack Developer</p>
        ...
        <div class="order-1 md:order-2 w-60 h-60 md:w-[40%] md:h-[40%] flex-shrink-0">
